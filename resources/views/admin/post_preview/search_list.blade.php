        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-4 mb-3">
                    <form class="d-flex" action="{{route('admin.posts_preview.search')}}" method="POST">
                        @csrf
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td>{{$post->title}}</td>
                                        <td>{{$post->category}}</td>
                                        <td><a href="{{route('posts_preview.show', $post->id)}}"><i class="far fa-eye"></i></a></td>
                                        <td><a href="{{route('posts_preview.edit', $post->id)}}"><i class="fas fa-pencil-alt text-success"></i></a></td>
                                        <td>
