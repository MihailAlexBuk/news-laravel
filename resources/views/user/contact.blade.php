                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-wrapper">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4>Немного о нас</h4>
                                <p>Данный проект является тестовой версией</p>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <blockquote class="blockquote">Пожалуйста, прочитайте <a href='{{route('user.license')}}'>Лицензионное соглашение и условия использования</a>.</blockquote>
                            </div>
                        </div><!-- end row -->
